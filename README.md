...
- Run in Terminal: `docker pull exsilium/unifi-video:v3.7.1`

```
`$ docker images
REPOSITORY             TAG                 IMAGE ID            CREATED             SIZE
exsilium/unifi-video   v3.7.1              1cbeb1e369da        44 minutes ago      869.9 MB
```

- (Optional) Download\Save `run.sh` from [here](https://raw.githubusercontent.com/exsilium/docker-unifi-video/v3.7.1/run.sh)
...
- Pull the latest image `docker pull exsilium/unifi-video:v3.7.1`
...
- Update the `run.sh` to reflect the new version (v3.7.1)
